...
class EnergiesExtensionElectricCharging(object):
    swagger_types = {
        'charging_mode': 'str',
        'charging_rate': 'int',
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnergiesExtensionElectricCharging, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnergiesExtensionElectricCharging):
            return False
